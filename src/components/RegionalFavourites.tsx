...
export function RegionalFavourites() {
  ...
  return (
    <section className="relative py-16 bg-[#FDFDFC]">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col items-center mb-12">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 bg-black/5 backdrop-blur-md text-black px-4 py-2 rounded-full text-[11px] font-bold tracking-[0.15em] uppercase mb-6"
          >
            <Sparkles size={14} />
